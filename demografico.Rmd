...
ggplot(alumnos6_panama, aes(x=PCRECRA6,y=puntaje_estandar_mat,color=factor(nina))) + geom_point() + stat_smooth(se=F,method=loess) + scale_colour_discrete(name="Genero",labels=c("Nino","Nina"))
```
...
ggplot(alumnos6_panama, aes(x=CONDIA6,y=puntaje_estandar_mat,color=factor(nina))) + geom_point() + stat_smooth(se=F,method=loess) + scale_colour_discrete(name="Genero",labels=c("Nino","Nina"))
```
...
ggplot(alumnos6_panama, aes(x=USOLIA6,y=puntaje_estandar_mat,color=factor(nina))) + geom_point() + stat_smooth(se=F,method=loess) + scale_colour_discrete(name="Genero",labels=c("Nino","Nina"))
```
...
ggplot(alumnos6_panama, aes(x=TMPLIBA6,y=puntaje_estandar_mat,color=factor(nina))) + geom_point() + stat_smooth(se=F,method=loess) + scale_colour_discrete(name="Genero",labels=c("Nino","Nina"))
```
...
ggplot(alumnos6_panama, aes(x=ASISDOA6,y=puntaje_estandar_mat,color=factor(nina))) + geom_point() + stat_smooth(se=F,method=loess) + scale_colour_discrete(name="Genero",labels=c("Nino","Nina"))
```
