...
ggplot(fp, aes(x=dependencia,y=puntaje_estandar,fill=subsgobf)) + geom_boxplot() + ggtitle("Distribucion de Puntaje por Subsidio de Gobierno") + xlab('')  + scale_x_discrete(labels=c('Publico', 'Privado'))
```
