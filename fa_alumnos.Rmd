...
ggplot(ap_panama, aes(x=tipo,y=puntaje_estandar,fill=DQA6IT06)) + geom_boxplot() + facet_grid( . ~ grado)
```

```{r etnia_rural, fig.width=12, fig.height=6, echo=F, message=F, warning=F}
ggplot(ap_panama[!is.na(ap_panama$ruralidad),], aes(x=tipo,y=puntaje_estandar,fill=DQA6IT06)) + geom_boxplot() + facet_grid( ruralidad ~ grado)
```
