...
ggplot(a, aes(x=MOTIVP,y=puntaje_estandar,color=tipo)) + geom_point(alpha=0.7) + stat_smooth(method=lm,se=F) + xlab("Índice de actitudes, motivación docente") + ylab("") 
```
...
ggplot(a, aes(x=CLAMBP,y=puntaje_estandar,color=tipo)) + geom_point(alpha=0.7) + stat_smooth(method=lm,se=F) + xlab("Índice de actitudes, motivación docente") + ylab("") 
```
```{r puntaje_prof_RELSALP, fig.width=12, fig.height=10, echo=F, message=F, warning=F}
a <- aggregate(puntaje_estandar ~ idtealin + tipo + RESALP, p6prof, mean)
ggplot(a, aes(x=RESALP,y=puntaje_estandar,color=tipo)) + geom_point(alpha=0.7) + stat_smooth(method=lm,se=F) + xlab("Índice de actitudes, motivación docente") + ylab("") 
```
...
ggplot(a, aes(x=RELDIRP,y=puntaje_estandar,color=tipo)) + geom_point(alpha=0.7) + stat_smooth(method=lm,se=F) + xlab("Índice de actitudes, motivación docente") + ylab("") 
```
...
ggplot(a, aes(x=VIOLENP,y=puntaje_estandar,color=tipo)) + geom_point(alpha=0.7) + stat_smooth(method=lm,se=F) + xlab("Índice de actitudes, motivación docente") + ylab("") 
```
...
ggplot(a, aes(x=APOYOP,y=puntaje_estandar,color=tipo)) + geom_point(alpha=0.7) + stat_smooth(method=lm,se=F) + xlab("Índice de actitudes, motivación docente") + ylab("") 
```
...
ggplot(a, aes(x=LIDERAP,y=puntaje_estandar,color=tipo)) + geom_point(alpha=0.7) + stat_smooth(method=lm,se=F) + xlab("Índice de actitudes, motivación docente") + ylab("") 
```
...
ggplot(a, aes(x=MONITOP,y=puntaje_estandar,color=tipo)) + geom_point(alpha=0.7) + stat_smooth(method=lm,se=F) + xlab("Índice de actitudes, motivación docente") + ylab("") 
```
...
ggplot(a, aes(x=DQPIT01,y=puntaje_estandar,color=tipo)) + geom_point(alpha=0.7) + stat_smooth(method=lm,se=F) + xlab("Cual es su Edad?") + ylab("")
```
...
ggplot(a, aes(x=DQPIT04,y=puntaje_estandar,color=tipo)) + geom_point(alpha=0.7) + stat_smooth(method=lm,se=F) + xlab(" ¿Hace cuantos años trabaja como docente?") + ylab("")
```
...
ggplot(a, aes(x=DQPIT05,y=puntaje_estandar,color=tipo)) + geom_point(alpha=0.7) + stat_smooth(method=lm,se=F) + xlab("") + ylab("")
```
